    ...
    <>
      <TopSection>
          ...
          <WrapContents>
            ...
            <div className='labelWrap'>
              ...
              <BottomLabel>
                ...
                <div className='etcOtcCodeDesc'>
                  {medicineItem?.etcOtcCode === 'Rx' ? (
                    <span className='tooltipText'>
                      You need a prescription to get this medication.
                    </span>
                  ) : (
                    <span className='tooltipText'>
                      You do not need to have a prescription to get this medication.
                    </span>
                  )}
                </div>
              </BottomLabel>
            ...
            <div className='boxWrap'>
              ...
              medicineItem?.medicineId === compareBoxArr[1].medicineId ? (
                <div className='compareBox'>Compare</div>
              ) : (
                <button
        ...
        <div
          ...
          <MiddleCardBox>
            ...
            <div
              ...
              <MatrialExplainWrap
                ...
                <div className='title'>
                  Material <span>{materialExplainName}</span>
                </div>
          ...
          <RightCardBox>
            <GraphLabel>Major Ingredients</GraphLabel>
            <GraphTop3>
...
const Image = styled.div`
  ...
  background-image: ${({ imgUrl }) =>
    imgUrl ? `url(${imgUrl})` : `url('/assets/image/NoImage.png')`};
