...
const Search = () => {
  ...
  const [searchSortList, setSearchSortList] = useState(['Name', 'Type']);
  const [searchKinds, setSearchKinds] = useState('Name');
      ...
      {searchedWord ? (
        <SearchResultWrap>
          <div className='ExplainWrap'>
            <span>Contact </span>&nbsp; Medical Provider for more details
          </div>
          <div className='searchTop'>
            <div className='searchTitleWrap'>
              <div className='searchText'>'{searchedWord}'</div>
              <div className='searchListNum'>
                Search Result: <span>{searchLength.toLocaleString()}</span>
              </div>
            </div>
          </div>
